...
public class SportsShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.show_sports,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                        //Toast.makeText(SportsShow.this, response, Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(SportsShow.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                            } else {
                        ...
                        newsAdapter = new NewsAdapter(SportsShow.this, newsUnitList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SportsShow.this, "vulval "+error.toString(), Toast.LENGTH_SHORT).show();

            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(SportsShow.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SportsShow.this,Details.class);
