...
public class MurderShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("MURDER");

        listView = (ListView) findViewById(R.id.listView);


        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.show_murder,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(MurderShow.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                            } else {
                        ...
                        newsAdapter = new NewsAdapter(MurderShow.this, newsUnitList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MurderShow.this, "vulval "+error.toString(), Toast.LENGTH_SHORT).show();

            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(MurderShow.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MurderShow.this,Details.class);
