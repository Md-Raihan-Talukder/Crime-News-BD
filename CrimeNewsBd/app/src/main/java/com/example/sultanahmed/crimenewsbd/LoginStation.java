...
public class LoginStation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(LoginStation.this);
    ...
    private void loginRequest(){
        ...
        pd.show();
        RequestQueue queue = Volley.newRequestQueue(LoginStation.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.matches(log)) {
                            startActivity(new Intent(getApplicationContext(), PoliceStationAdd.class));
                        }
                        else {
