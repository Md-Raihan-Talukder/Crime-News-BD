...
public class RobberyShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ROBBERY");

        listView = (ListView) findViewById(R.id.listView);


        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.show_robbery,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                        //Toast.makeText(RobberyShow.this, response, Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(RobberyShow.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                            } else {
                        ...
                        newsAdapter = new NewsAdapter(RobberyShow.this, newsUnitList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(RobberyShow.this, "vulval "+error.toString(), Toast.LENGTH_SHORT).show();

            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(RobberyShow.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(RobberyShow.this,Details.class);
